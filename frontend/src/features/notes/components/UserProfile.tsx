...
import { Calendar, FileText, LogOut, Mail, Sparkles, X } from "lucide-react";
...
const UserProfile = ({ onOpenChange }: UserProfileProps) => {
    ...
    return (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/30 dark:bg-black/70">
            <div className="relative bg-background dark:bg-muted rounded-lg p-6 w-80 sm:w-96">
                ...
                >
                    <X className="h-4 w-4 text-foreground/80" strokeWidth={2.5} />
                </button>
                ...
                {/* Account info card */}
                <div className="mt-3 rounded-2xl border border-border bg-background/60 py-2 px-4 dark:bg-background/40">
                ...
                {/* Activity stats */}
                <div className="mt-2 font-nunito">
                ...
                {/* Actions */}
                <div className="w-full mt-7 flex flex-col-reverse gap-3 justify-between sm:flex-row ">
                    <button
                        onClick={() => onOpenChange(false)}
                        className="w-full px-4 py-2 rounded-[5px] text-foreground bg-card border border-gray-300 hover:bg-secondary sm:w-auto cursor-pointer"
                    >
                        Cancel
                    </button>
                    ...
                    <AlertDialog>
                        ...
                        <AlertDialogContent size="sm">
                            ...
                            <AlertDialogFooter>
                                ...
                                <AlertDialogAction onClick={handleLogout} className="bg-red-400! text-white!">Logout</AlertDialogAction>
                            </AlertDialogFooter>
                        </AlertDialogContent>
                    </AlertDialog>
                </div>
