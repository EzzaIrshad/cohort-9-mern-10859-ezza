...
const EditorTopBar = ({isEdit}: Props) => {
  return (
    <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
                ...
                <div className="flex items-center gap-2">
                    ...
                    <button className="group inline-flex shrink-0 items-center justify-center gap-1 cursor-pointer sm:gap-2 rounded-full bg-accent border border-pink px-2.5 sm:px-5 py-1.75 md:py-2.5 text-xs sm:text-sm font-semibold text-card input-shadow">
